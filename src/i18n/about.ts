export const about = {
    ...
    zh: {
        about: {
            title: '关于片轮少女',
            intro: '片轮少女是一个美少女恋爱游戏，背景架设在一所专门为残疾儿童而设的山久高校，地点位于现代日本某处。中井久夫是一个有着正常生活的普通男孩，但一次先天性心肌缺损引发的意外迫使他长期住院，之后不得不转到一所新学校。尽管困难重重，他还是交上了新的朋友——如果他能做出正确的选择，甚至还能拥有爱情。游戏中有5条主线分别对应5位女主角，每条主线都是为该角色精心设计的。',
            gameplay: '故事以男主角的视角和第一人称叙述来推进故事。游戏包含有成人内容。是由<a href="http://renpy.org/">Ren\'Py</a>脚本系统制作，使用传统的文字叙事方式，剧情选择对话框，并辅以单独绘制人物制作成的视觉小说。',
            info: '片轮少女目前正在由<a href="staff">一个国际性非专业开发组</a>进行开发，并将以<a href="http://creativecommons.org/licenses/by-nc-nd/3.0/deed.zh">知识共享“姓名标示-非商业性-禁止改作”条款(BY-NC-ND)</a>免费发行。目前游戏发行日期未定。'
        }
    },
    'zh-TW': {
        about: {
